...
## 1.2. Estructura
📅 **Ha caído:** 2025 — composición exacta de la CE (títulos, artículos y disposiciones).
...
- **Composición de la CE**: Título Preliminar, diez Títulos, 169 artículos y disposiciones 4-9-1-1 (§1.2) — la trampa jugaba con "once Títulos" y "cinco adicionales".
- Elecciones periódicas por **sufragio universal** en el derecho de participación del art. 23 (§5).
